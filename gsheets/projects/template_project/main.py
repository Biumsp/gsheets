...
spreadsheet = client.open_by_url('https://docs.google.com/spreadsheets/d/10Z31s0rlv-LNQzrMrI-SOl6TPkmoiF0CZYqpYTv277U/edit#gid=1655103781')

# execute all rules
for rule in rules: rule(spreadsheet)
